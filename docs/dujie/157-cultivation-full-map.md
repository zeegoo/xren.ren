...
今天这篇不教你新东西，但给你一张修炼地图。以后任何时候迷茫了，回来翻这张图——从凡人到飞升，一共就这六大境界。
...
工作十年的程序员还在"炼气"，往往不是不努力——是他的认知层级没上去，技能再多也只是"会更多炼气期的招式"。
...
视觉语言上：颜色的递进就是修为的递进。浅色是初期，深色是后期。从炼气（暖黄→橙红）→ 筑基（浅蓝→深蓝）→ 金丹（淡紫→深紫）→ 元婴（粉红→玫红）→ 化神（金黄→琥珀）→ 渡劫（青蓝→青色）→ 大乘（金色镶红边）。
...
这五个判断题就是六大境界的阶梯。你能答到哪一层，就在哪个境界。
...
第28篇给你的是全局视角：你现在走的路在哪、前面还有什么路、每段路的判断标准是什么。读完整篇，你应该能在脑中画出从"凡人"到"大乘"的完整地图，然后知道自己在哪、要去哪、怎么去。
...
*本文是「码农修仙传」系列第157篇。系列导航见 [xren.ren](https://xren.ren)*